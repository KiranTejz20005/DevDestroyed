...
export default function FAQ() {
    ...
    const faqItems = [
        ...
        { 
          q: "Why is it so mean?", 
          a: "It's called tough love babe. The AI is trained to be satirical towards your GitHub habits. If it hits a little too close to home, maybe it's time to close the app and touch grass." 
        },
        { 
